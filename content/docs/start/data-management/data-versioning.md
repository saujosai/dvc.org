...
(usually a cloud storage service). For simplicity, let's set up a "local remote"
(another directory in the local file system) in a temporary `dvcstore/` directory:
